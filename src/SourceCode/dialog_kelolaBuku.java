 ...
 * @author Bagas
 */
public class dialog_kelolaBuku extends java.awt.Dialog {

    /**
     * Creates new form dialog_kelolaBuku
     */
    public dialog_kelolaBuku(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_kelolaBuku dialog = new dialog_kelolaBuku(new java.awt.Frame(), true);
