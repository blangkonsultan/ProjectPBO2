 ...
 * @author Bagas
 */
public class dialog_kelolaPeminjaman extends java.awt.Dialog {

    /**
     * Creates new form dialog_kelolaBuku
     */
    public dialog_kelolaPeminjaman(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_kelolaPeminjaman dialog = new dialog_kelolaPeminjaman(new java.awt.Frame(), true);
