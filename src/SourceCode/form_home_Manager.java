 ...
 * @author Bagas
 */
public class form_home_Manager extends javax.swing.JFrame {

    /**
     * Creates new form form_home_admin
     */
    public form_home_Manager() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_home_Manager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_home_Manager().setVisible(true);
            }
        });
    }
