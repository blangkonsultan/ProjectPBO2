 ...
 * @author Bagas
 */
public class dialog_cetakLaporanBuku extends java.awt.Dialog {

    /**
     * Creates new form dialog_cetakLaporanBuku
     */
    public dialog_cetakLaporanBuku(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialog_cetakLaporanBuku dialog = new dialog_cetakLaporanBuku(new java.awt.Frame(), true);
