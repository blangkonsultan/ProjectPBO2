 ...
 * @author Bagas
 */
public class view_dialog_cetakLaporanBuku extends java.awt.Dialog {

    /**
     * Creates new form dialog_cetakLaporanBuku
     */
    public view_dialog_cetakLaporanBuku(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Table_DataMahasiswa.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "FAKULTAS", "NIM", "NAMA", "KATEGORI", "TEMPAT LAHIR", "TANGGAL LAHIR"
            }
        ) {
...
//            public void run() {
//                view_dialog_cetakLaporanBuku dialog = new view_dialog_cetakLaporanBuku(new java.awt.Frame(), true);
